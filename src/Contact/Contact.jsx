...
//         window.location.href = `mailto:support@whot.ca?subject=${subject}&body=${body}`;
...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formDataToSend.append("access_key", "66323cb7-4f63-46a4-a14f-29a9afdaf9db");
        ...
        if (data.success) {
            setResult("Thank you! Your reservation request has been sent successfully.");
            // Reset form
            setFormData({
                firstName: '',
                lastName: '',
