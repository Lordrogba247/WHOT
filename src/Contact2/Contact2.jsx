    ...
    return (
        <section className="contact2-section">
            <div className="contact2-container">
                <h2 className="contact2-title">Contact</h2>

                <div className="contact2-content">
                    {/* Address */}
                    <div className="contact2-column">
                        <h3 className="contact2-heading">Address</h3>
                        <a
                            href="https://www.google.com/maps/search/?api=1&query=7694+Islington+Ave+Woodbridge+Ontario+L4L+1W3+Canada"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="contact2-text contact2-address-link"
                        >
                            7694 Islington Ave,<br />
                            Woodbridge, Ontario L4L 1W3,<br />
                            Canada
                        </a>
                    </div>
                    ...
                    {/* Contacts */}
                    <div className="contact2-column">
                        <h3 className="contact2-heading">Contacts</h3>
                        <p className="contact2-text">
                            <a href="tel:+19052660331" className="contact2-link">+1 905-266-0331</a>
                        </p>
                        <p className="contact2-text">
                            <a href="mailto:info@whot.ca" className="contact2-link">info@whot.ca</a>
                        </p>
                    </div>

                    {/* Social Media */}
                    <div className="contact2-column">
                        <h3 className="contact2-heading">Follow us:</h3>
